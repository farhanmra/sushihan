...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="menu.php">All Product</a>
                                </li>
                                <li>
                                    <a href="menu.php?kd=1">Insektisida</a>
                                </li>
                                <li>
                                    <a href="menu.php?kd=2">Pupuk</a>
                                </li>
                                <li>
                                    <a href="menu.php?kd=3">Obat</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            ...
            </td><td align="right"><a href="add_menu.php"><i class="fa fa-plus" aria-hidden="true"></i>Tambah Data Disini</a></td></tr></table>
                        </div>
                        <!-- /.panel-heading -->
