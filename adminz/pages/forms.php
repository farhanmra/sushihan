...
if(isset($nama_produk) or isset($isi) or isset($deskripsi) or isset($id_kategori) or isset($berat) or isset($harga))
{
 ...
 if(($_FILES["file"]["type"] == "image/jpeg") and ($_FILES["file"]["size"] <= 2000000)){
     if (file_exists("upload/" . $_FILES["file"]["name"])){
       ...
       $insert = "INSERT INTO produk SET nama_produk = '$nama_produk',isi = '$isi',gambar = 'images/".$_FILES["file"]["name"]."',deskripsi = '$deskripsi' ,id_kategori = '$id_kategori', 
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="produk.php?kd=1">Insektisida</a>
                                </li>
								<li>
                                    <a href="produk.php?kd=2">Pupuk</a>
                                </li>
								<li>
                                    <a href="produk.php?kd=3">Obat</a>
                                </li>
                            </ul>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="forms.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Isi</label>
                                            <input class="form-control" name="isi" placeholder="dalam ml" required>
                                        </div>
										<div class="form-group">
                                            <label>Gambar</label>
