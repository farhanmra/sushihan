	...
	<div class="about">
		<div class="w3_agileits_contact_grids">
			<div class="col-md-6 w3_agileits_contact_grid_left">
				<div class="agile_map">
					<iframe src="https://www.google.co.id/maps/place/Hotel+Santika+Premiere+Kota+Harapan+Indah/@-6.1826571,106.9837672,17z/data=!4m6!3m5!1s0x2e698bbbc7f869a9:0xd3a2ab12449e6cf1!4b1!8m2!3d-6.1849867!4d106.9759987?hl=en&authuser=0" style="border:0"></iframe>
				</div>
				<div class="agileits_w3layouts_map_pos">
					<div class="agileits_w3layouts_map_pos1">
						<h3>Contact Info</h3>
						<p> Pejuang Jaya Blok C 589Harapan Indah, Bekasi Barat.</p>
						<ul class="wthree_contact_info_address">
							<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">farhanrivkha146@gmail.com</a></li>
							<li><i class="fa fa-phone" aria-hidden="true"></i>+(62)8596-005-258-54</li>
						</ul>
						<div class="w3_agile_social_icons w3_agile_social_icons_contact">
							<ul>
								<li><a href="https://twitter.com/sushiiihan" class="icon icon-cube agile_facebook"></a></li>
