...
{
 $sql_query="DELETE FROM barang WHERE nobar=".$_GET['delete1_id'];
...
<head>
 ...
 <script type="text/javascript">
      function edit1_id(nobar)
      {
       if(confirm('Edit Data Barang ?'))
       {
        window.location.href='edit1.php?edit1_id='+nobar;
       }
      }
      function delete1_id(nobar)
      {
       if(confirm('Hapus Data Barang ?'))
       {
        window.location.href='menu.php?delete1_id='+nobar;
       }
      }
    </script>  
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
													...
													if(!empty($aho)){
														...
														echo 'Semua Ukuran Sushi';
													};
													//cuma nampilin 1 aja sepanjang ini ....... -_______-
													?>
													
												</td><td align="right"><a href="tambah.php"><i class="fa fa-plus" aria-hidden="true"></i>Tambah Data Sushi Disini</a></td></tr></table>
                         </div>
                        <!-- /.panel-heading -->
