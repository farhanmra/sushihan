...
if(isset($nabar) or isset($deskripsi)or isset($jenis) or isset($harga) or isset ($stok) or isset($berat))
{
 ...
 if(($_FILES["file"]["type"] == "image/jpeg") and ($_FILES["file"]["size"] <= 2000000)){
     if (file_exists("upload/" . $_FILES["file"]["name"])){
       ...
       $insert = "INSERT INTO barang SET image = 'image/".$_FILES["file"]["name"]."',nabar = '$nabar',deskripsi = '$deskripsi',jenis = '$jenis',harga = '$harga',stok='$stok',berat = '$berat'";
       $query = mysql_query($insert);
       if($query == TRUE)
       {
        	echo '<script language="javascript">alert("Data berhasil Ditambahkan"); document.location="./menu.php";</script>';
       }
       else
       {
      echo '<script language="javascript">alert("Data gagal Ditambahkan"); document.location="./menu.php";</script>';
       }
     }
   }
}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" action="tambah.php" enctype="multipart/form-data">
										...
										<div class="form-group">
                                            <label>berat</label>
                                            <input class="form-control" name = "berat" required >
                                        </div>>
										
                                        <button type="submit" class="btn btn-default">Submit Button</button>
                                        <a href = "./index.php" button type="reset" class="btn btn-default">Cancel Button</a></button>
                                    </form>
                                </div>
