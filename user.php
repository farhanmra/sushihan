      ...
      if(isset($_GET['stat'])){
        if($_GET['stat']=='none'){
          echo '<div class="alert alert-info" role="alert" align="center">
           <strong>Oke!</strong> Data Anda tidak diperbarui.
          </div>';
        }
      if($_GET['stat']=='success'){
        echo '<div class="alert alert-success" role="alert" align="center">
         <strong>Selamat!</strong> Data Anda berhasil diperbarui.
        </div>';
      }
      if($_GET['stat']=='fail'){
        echo '<div class="alert alert-danger" role="alert" align="center">
         <strong>Opps maaf!</strong> Data Anda gagal diperbarui, silahkan coba beberapa saat lagi.
        </div>';
      }}
      if(isset($_GET['page'])){
        if($_GET['page']==1){
          echo '<h2 class="top" align="center">Edit Profile</h2><br/>';
